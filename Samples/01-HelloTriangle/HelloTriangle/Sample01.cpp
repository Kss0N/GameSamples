...
std::filesystem::path Sample01::getBasePath()
{
	TCHAR name[MAX_PATH];
...
void Sample01::recordCommandList(ID3D12GraphicsCommandList* cmdlist)
{
...
void Sample01::OnSurfaceLoaded(HWND hWnd, UINT width, UINT height)
{
